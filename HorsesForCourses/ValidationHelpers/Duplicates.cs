namespace HorsesForCourses.ValidationHelpers;
...
public static class Duplicates
{
    ...
    public static void NoDuplicatesAllowed<T, TException>(this IEnumerable<T> collection)
        where TException : Exception, new()
            => NoDuplicatesAllowed(collection, _ => new TException());

    public static void NoDuplicatesAllowed<T, TException>(
